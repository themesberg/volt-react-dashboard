        ...
        <SimpleBar className={`collapse ${showClass} sidebar d-md-block bg-primary text-white`}>
          <div className="sidebar-inner px-4 pt-3">
            ...
            <Nav className="flex-column pt-3 pt-md-0">
              <NavItem title="Trashnet" link={Routes.Presentation.path} image={ReactHero} />
              ...
              <NavItem title="Ledger" icon={faHandHoldingUsd} link={Routes.Transactions.path} />
              <NavItem title="Statements" icon={faHandHoldingUsd} link={Routes.Transactions.path} />
              ...
              {/* <CollapsableNavItem eventKey="tables/" title="Tables" icon={faTable}>
                <NavItem title="Statements" link={Routes.BootstrapTables.path} />
              </CollapsableNavItem> */}
